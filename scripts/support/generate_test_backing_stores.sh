...
if [[ -n "$1" ]]; then
    ...
    $HAKC_OPT -passes=hakc --hakc-config=$HAKC_TEST_ROOT/hakc_test$1/hakc_dag_config.yml $HAKC_TEST_ROOT/hakc_test$1/hakc_test$1.orig.ll -o $HAKC_TEST_ROOT/hakc_test$1/hakc_test$1.tmp.ll
