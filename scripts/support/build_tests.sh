...
if [[ -n "$1" ]]; then
    # removing per test case timeouts because that stopped working (says feature was disabled). Not needed now anyways.
    # llvm-lit -v TestCases/Posix/hakc-test$1.c
      echo TestCases/Posix/hakc_test$1/hakc_test$1.c
      $HAKC_LLVM_BUILD_PATH/llvm-project/llvm/bin/llvm-lit -a TestCases/Posix/hakc_test$1/hakc_test$1.c
else
...
# debugging command:
# /home/al32163/hakc/cmake-build-hakc-llvm/llvm-project/llvm/bin/opt -S -passes=hakc --hakc-config=/home/al32163/hakc/llvm-project/llvm/test/Transforms/Compartmentalization/hakc_test_kuzu8/hakc_comp_config.yml /home/al32163/hakc/cmake-build-hakc-llvm/llvm-project/llvm/test/Transforms/Compartmentalization/hakc_test_kuzu8/Output/hakc_test_kuzu8.c.tmp.orig.ll -o /home/al32163/hakc/cmake-build-hakc-llvm/llvm-project/llvm/test/Transforms/Compartmentalization/hakc_test_kuzu8/Output/hakc_test_kuzu8.c.tmp.out.ll
# test command:
# /home/al32163/hakc/install/bin/opt -S -passes=hakc --hakc-config=/home/al32163/hakc/llvm-project/llvm/test/Transforms/Compartmentalization/hakc_test_kuzu8/hakc_comp_config.yml /home/al32163/hakc/cmake-build-hakc-llvm/llvm-project/llvm/test/Transforms/Compartmentalization/hakc_test_kuzu8/Output/hakc_test_kuzu8.c.tmp.orig.ll -o /home/al32163/hakc/cmake-build-hakc-llvm/llvm-project/llvm/test/Transforms/Compartmentalization/hakc_test_kuzu8/Output/hakc_test_kuzu8.c.tmp.out.ll
