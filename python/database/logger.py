# logger.py
# Implemented by Allan Nesathurai : ahnesathurai@gmail.com, allan.nesathurai@ll.mit.edu
import logging
...
addLoggingLevel("VOTE", 56)
addLoggingLevel("ELECTION", 57)
...
class CustomFormatter(logging.Formatter):
    ...
    FORMATS = {
        ...
        logging.VOTE: yellow + format + msg + reset,
        logging.ELECTION: bold_yellow + format + msg + reset
    }
...
if __name__ == '__main__':
    ...
    logger.vote("voting on new primary")
    logger.election("primary received")