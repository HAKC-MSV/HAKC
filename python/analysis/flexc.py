...
from flexc_algos import GreedyAlgorithm, FilesystemAlgorithm, EqualCompartmentSizeAlgorithm
...
def setup_algorithms(parser) -> list[FlexCAlgorithm]:
    ...
    algos = [GreedyAlgorithm.GreedyAlgorithm(algo_parser), FilesystemAlgorithm.FilesystemAlgorithm(algo_parser),
             EqualCompartmentSizeAlgorithm.EqualCompartmentSizeAlgorithm(algo_parser)]
